...
function validar_emails() {
    const email1 = document.getElementById('id_email1').value;
    const email2 = document.getElementById('id_email2').value;
...
function mostrar_validacion_rut(event) {
    ...
    if (!rutInput) {
        console.error('Element with id="id_rut" not found.');
        return;
    }
